...
Point::Point(std::vector<bool> index, double& x, double& y, const double& mass, double& vecX, double& vecY)
	: QuadrantIndex(index), xCor(x), yCor(y), mass(mass), vecX(vecX), vecY(vecY) {}; //Constructor
